...
def testMover(g1, g2):
    ...
    print(f'tokenized g1: {g1}')
    print(f'tokenized g2: {g2}')
    mover_score = mover_corpus_score([g1], [[g2]])
    print(f'mover score: {mover_score}')
    pass

if __name__ == '__main__':
    #testBleu("to travel in a caravan ( procession ).", "A convoy or procession of travelers.")
    testMover("to travel in a caravan ( procession ).", "A convoy or procession of travelers.")