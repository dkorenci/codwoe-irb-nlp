'''
Torch models for mapping between different word embeddings.
'''
...
class Embed2EmbedMLP(nn.Module):
    """MLP for estimating embedding from embedding."""

    def __init__(self, d_model=256, n_layers=1, dropout=0.3, **kwargs):
        super(Embed2EmbedMLP, self).__init__()
